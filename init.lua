...
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>') --  See `:help hlsearch` -- Clear highlights on search when pressing <Esc> in normal mode

-- Testing here
-- Past this

vim.keymap.set('n', '<leader>Ac', '0d$kPa<Space><Esc>') -- Move comment to end of line beneath
